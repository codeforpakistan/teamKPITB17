...
<!-- Mirrored from html.stackthemes.net/Crowd Durshal-preview/elements.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Apr 2017 07:18:32 GMT -->
<head>
 ...
 <!--  <section class="header-bottom">
  ...
  <section class="white" id="how-it-works">
    <article class="container" id="intor-section">
     ...
     <a  href="company.php">   <li class="text-area">
          <span class="intro-icon"><i class="icon-community2"></i></span>
          <strong>Start a Pitch<span class="line-yellow"></span> </strong> Etiam porta sem malesuada mama rnolis euismod. Lorem osun.
        </li>
      </a>
      <!--   <li class="plus-icon">&nbsp;</li> -->
       <li></li>
  <a href="#">      <li class="text-area">
          <span class="intro-icon"><i class="icon-publicpower"></i></span>
          <strong>Invest Money  <span class="line-red"></span> </strong> Etiam porta sem malesuada mama rnolis euismod. Lorem osun.
        </li> </a>
      </ul>
    </article>
  </section>
