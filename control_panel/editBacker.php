...
$id = @$_GET['backerID'];
$sql = "select * from tblbackers where id=$id";
$query = new database();
...
if ($_POST) {
    if (@$_FILES['img']['name'] != '') {
        ...
        $id = $_POST['backerID'];
        $sql = $query->update_record('tblbackers', $fields, "id = $id");
         ...
         <div id="page-wrapper">
             <?php
                ...
                ?>
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Edit Backer</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <input type="hidden" name="backerID" value="<?php echo $row['id']; ?>" />
                                    <div class="col-lg-12">
