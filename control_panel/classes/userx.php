...
$company_query=mysqli_query($connect, "insert into usercompany set c_ntn='$cntn',c_name='$cname',c_regno='$cregno',c_email='$cemail',
	c_website='$cwebsite',c_phone='$cphone',c_detail='$cdetail',UserID='$userid',hash='$hash'");
...
if(mail)
{
 $_SESSION['msg']='<span class="alert alert-info"><strong>Please Check Your Email For  For Verification or <a href="../../layout.php?tabe=companies"> View Your Company</a></strong> </span>';	
...
//".$_SESSION['comp_id']."
  ...
  $query=mysqli_query($connect, "insert into tblproject set
     p_title= '$ptitle',
 	p_amount='$pamount',
	...
	p_lnkdin='$lnkdin',
	p_profile='$profile',
 	UserID='$userid'")or die(mysqli_connect_error());
 if($query){
