...
<div class="wrapper"> 
        ...
        <div class="title">
          <ul>
            <li data-link="add-perks" class="current"><a href="#"><i class="fa fa-tags"></i><span>Select Perk</span></a></li>
              <li data-link="social-media" class=""><a href="#"><i class="fa fa-book"></i><span>Agreement</span></a></li>    
 ...
 <div id="add-perks" class="form-wizard active">
 ...
 <br>
            ...
            <div>
              ...
              <div class="next-btn">
                ...
                <button type="button" class="btn btn-4 blue btn-next" data-link="social-media" onClick="moveform(this,'social-media')">Next</button>
              </div>
            </div>
